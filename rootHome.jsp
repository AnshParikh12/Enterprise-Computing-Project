...
<html lang="en">
    ...
    <body>
        ...
        <hr>
        <p>You are connected to the Project 4 Enterprise System database as a <span>root-level</span> user. <br>Please enter any SQL query or update command in the box below.</p>
        <form action="rootHome" method="post" class="sql-box">
